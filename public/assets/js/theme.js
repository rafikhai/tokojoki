...
document.addEventListener("DOMContentLoaded", function() {
  ...
  faqToggleBtns.forEach(function(btn) {
    btn.addEventListener('click', function() {
      ...
      // Ambil elemen jawaban yang terkait dengan tombol yang diklik
      var answer = this.nextElementSibling;

      // Slide down atau slide up jawaban sesuai dengan keadaan saat ini
...
//animasi about us
document.addEventListener("DOMContentLoaded", function () {
  const logoImg = document.querySelector(".aboutus");

  const observer = new IntersectionObserver((entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        logoImg.classList.add("animate__animated", "animate__slideInRight");
      } else {
        logoImg.classList.remove("animate__animated", "animate__slideInRight");
      }
    });
  });
...
//animasi home
document.addEventListener("DOMContentLoaded", function () {
  const logoImg = document.querySelector(".home");

  const observer = new IntersectionObserver((entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        logoImg.classList.add("animate__animated", "animate__zoomInDown");
      } else {
        logoImg.classList.remove("animate__animated", "animate__fadeIn");
      }
    });
  });
...
//animasi trusted
document.addEventListener("DOMContentLoaded", function () {
  const logoImg = document.querySelector(".trusted");

  const observer = new IntersectionObserver((entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        logoImg.classList.add("animate__animated", "animate__slideInLeft");
      } else {
        logoImg.classList.remove("animate__animated", "animate__slideInLeft");
      }
    });
  });
...
//animasi video tiktok
document.addEventListener("DOMContentLoaded", function () {
  const logoImg = document.querySelector(".videotiktok");
...
//animasi faq
document.addEventListener("DOMContentLoaded", function () {
  const logoImg = document.querySelector(".faq1");
...
document.addEventListener("DOMContentLoaded", function () {
  const logoImg = document.querySelector(".faq2");
...
//animasi how to order
document.addEventListener("DOMContentLoaded", function () {
  const logoImg = document.querySelector(".howtoorder");
